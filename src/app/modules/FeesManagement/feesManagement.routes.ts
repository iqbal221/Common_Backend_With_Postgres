...
import { FeesManagementController } from './feesManagement.controller';
import { FeesManagementValidation } from './feesManagement.validation';
...
router.post(
  '/',
  validateRequest(FeesManagementValidation.create),
  // auth(ENUM_USER_ROLE.SUPER_ADMIN, ENUM_USER_ROLE.ADMIN),
  FeesManagementController.InsertIntoDB
);
...
router.get('/', FeesManagementController.GetAllFromDB);

export const FeesManagementRoutes = router;
